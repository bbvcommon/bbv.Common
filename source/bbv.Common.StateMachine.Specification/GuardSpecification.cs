//-------------------------------------------------------------------------------
// <copyright file="GuardSpecification.cs" company="bbv Software Services AG">
        ...
        private Establish context = () =>
            {
                ...
                machine.In(SourceState)
                    .On(Event)
                        .If(_ => false).Goto(ErrorState)
                        .If(_ => true).Goto(DestinationState)
                        .If(_ => true).Goto(ErrorState)
