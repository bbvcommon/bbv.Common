//-------------------------------------------------------------------------------
// <copyright file="DefinitionBuilderTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Syntax
{
    ...
    public class DefinitionBuilderTest
    {
        ...
        public void ByEvaluatingWithSingleExpressionProvider()
        {
            ...
            var expressions = this.GetExpressionsFromTestee(testQuestion);
        ...
        public void ByEvaluatingWithInlineExpression()
        {
            ...
            var testQuestion = new TestQuestion();
            var expressionProvider = this.testee.Definition.GetExpressionProviders(testQuestion);
