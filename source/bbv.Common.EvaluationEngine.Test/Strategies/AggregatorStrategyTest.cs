//-------------------------------------------------------------------------------
// <copyright file="AggregatorStrategyTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Strategies
{
    using System;
    ...
    public class AggregatorStrategyTest
    {
        ...
        [Fact]
        public void MappingAggregatorExecute()
        {
        ...
        private class TestableDefinition<TExpressionResult> : IDefinition<TestQuestion, string, int, TExpressionResult>
        {
            ...
            public void AddExpressionProviderSet(IExpressionProviderSet<TestQuestion, string, int, TExpressionResult> set)
            {
                throw new NotImplementedException();
            }
        }
