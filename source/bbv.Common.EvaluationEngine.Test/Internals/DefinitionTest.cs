//-------------------------------------------------------------------------------
// <copyright file="DefinitionTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Internals
{
    ...
    public class DefinitionTest
    {
        ...
        [Fact]
        public void ExpressionProviders()
        {
        ...
        [Fact]
        public void CloneMergeThenStrategyIsCopied()
        {
        ...
        [Fact]
        public void CloneMergeThenAggregatorIsCopied()
        {
            var clone = this.testee.Clone();
        ...
        [Fact]
        public void CloneMergeThenExpressionProviderSetsAreCopied()
        {
            var question = new TestQuestion();
