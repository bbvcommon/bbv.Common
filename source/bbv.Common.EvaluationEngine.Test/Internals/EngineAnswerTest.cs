//-------------------------------------------------------------------------------
// <copyright file="EngineAnswerTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Internals
{
    ...
    public class EngineAnswerTest
    {
        ...
        [Fact]
        public void AnswerWhenNoDefinitionExistsThenException()
        {
            var question = new TestQuestion();
        ...
        [Fact]
        public void AnswerWhenNoStrategyExistsThenException()
        {
            var question = new TestQuestion();
            var definitionMock = new Mock<IDefinition>();
