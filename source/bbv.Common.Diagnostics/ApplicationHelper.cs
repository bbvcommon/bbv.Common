//-------------------------------------------------------------------------------
// <copyright file="ApplicationHelper.cs" company="bbv Software Services AG">
...
namespace bbv.Common.Diagnostics
{
    ...
    public static class ApplicationHelper
    {
        ...
        public static bool CheckApplicationAlreadyRunning(bool switchToAlreadyRunningProcess)
        {
            ...
            if (processes.Length > 1)
            {
                if (switchToAlreadyRunningProcess)
                {
                    ...
                    {
                        ShowWindowAsync(hwnd, 1); // maximize window
                    }
        ...
        private static extern int ShowWindowAsync(IntPtr windowHandle, int showWindowCommand);
