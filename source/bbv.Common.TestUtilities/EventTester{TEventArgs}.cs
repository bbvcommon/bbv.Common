// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EventTester{TEventArgs}.cs" company="bbv Software Services AG">
...
namespace bbv.Common.TestUtilities
{
    ...
    public class EventTester<TEventArgs> : AbstractEventTester<EventHandler<TEventArgs>, TEventArgs> where TEventArgs : EventArgs
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventTester{TEventArgs}"/> class.
        /// </summary>
        ...
        public EventTester(object sender, string eventName, Func<object, TEventArgs, bool> eventMatcher, string eventMatcherDescriptor)
        ...
        /// current invocation count does not match this value.
        /// </param>
        public EventTester(object sender, string eventName, Func<object, TEventArgs, bool> eventMatcher, string eventMatcherDescriptor, int expectedInvocationCount)
        ...
        public EventTester(object sender, string eventName, EventHandler<TEventArgs> eventHandler)
        ...
        /// <param name="eventMatcher">The event matcher that is used to determine whether the event shall be taken into account.</param>
        /// <param name="eventMatcherDescriptor">The event matcher descriptor which is used to annotate the event with matching information.</param>
        public EventTester(object sender, string eventName, EventHandler<TEventArgs> eventHandler, Func<object, TEventArgs, bool> eventMatcher, string eventMatcherDescriptor)
        ...
        /// current invocation count does not match this value.
        /// </param>
        public EventTester(object sender, string eventName, EventHandler<TEventArgs> eventHandler, int expectedInvocationCount)
        ...
        /// current invocation count does not match this value.
        /// </param>
        public EventTester(object sender, string eventName, EventHandler<TEventArgs> eventHandler, Func<object, TEventArgs, bool> eventMatcher, string eventMatcherDescriptor, int expectedInvocationCount)
        ...
        protected override void Fire(object sender, TEventArgs e)
        {
