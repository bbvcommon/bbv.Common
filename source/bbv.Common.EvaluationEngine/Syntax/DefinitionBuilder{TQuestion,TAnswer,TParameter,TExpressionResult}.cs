//-------------------------------------------------------------------------------
// <copyright file="DefinitionBuilder{TQuestion,TAnswer,TParameter,TExpressionResult}.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Syntax
{
    using System;
        ...
        where TQuestion : IQuestion<TAnswer, TParameter>
    {
        ...
        {
            this.currentSet = new ExpressionProviderSet<TQuestion, TAnswer, TParameter, TExpressionResult>();
            this.currentSet.Condition = condition;
        ...
        /// <returns>Constraint syntax</returns>
        public IConstraintSyntax<TQuestion, TAnswer, TParameter, TExpressionResult> ByEvaluating(Expression<Func<TQuestion, TParameter, TExpressionResult>> expression)
        {
            var provider = new InlineExpressionProvider<TQuestion, TAnswer, TParameter, TExpressionResult>(expression);
