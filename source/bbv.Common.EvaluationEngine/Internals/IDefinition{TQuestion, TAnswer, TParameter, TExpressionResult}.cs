//-------------------------------------------------------------------------------
// <copyright file="IDefinition{TQuestion, TAnswer, TParameter, TExpressionResult}.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Internals
{
        ...
        where TQuestion : IQuestion<TAnswer, TParameter>
    {
        ...
        void AddExpressionProviderSet(IExpressionProviderSet<TQuestion, TAnswer, TParameter, TExpressionResult> set);
    }
}