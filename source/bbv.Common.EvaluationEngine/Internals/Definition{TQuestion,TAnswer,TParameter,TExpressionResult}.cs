//-------------------------------------------------------------------------------
// <copyright file="Definition{TQuestion,TAnswer,TParameter,TExpressionResult}.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine.Internals
{
        ...
        where TQuestion : IQuestion<TAnswer, TParameter>
    {
        ...
        public void AddExpressionProviderSet(IExpressionProviderSet<TQuestion, TAnswer, TParameter, TExpressionResult> set)
        {
            this.expressionProvidersSets.Add(set);
        }
