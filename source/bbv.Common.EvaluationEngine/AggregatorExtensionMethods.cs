//-------------------------------------------------------------------------------
// <copyright file="AggregatorExtensionMethods.cs" company="bbv Software Services AG">
...
namespace bbv.Common.EvaluationEngine
{
    ...
    using bbv.Common.EvaluationEngine.Validation;
    using bbv.Common.EvaluationEngine.Validation.Aggregators;
