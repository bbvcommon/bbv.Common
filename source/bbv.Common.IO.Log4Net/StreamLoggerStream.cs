//-------------------------------------------------------------------------------
// <copyright file="StreamLoggerStream.cs" company="bbv Software Services AG">
...
namespace bbv.Common.IO
{
    ...
    /// </summary>
    public class StreamLoggerStream : StreamDecoratorStream
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamLoggerStream"/> class.
        /// </summary>
        ...
        public StreamLoggerStream(Stream stream, ILog logger, int bytesPerLine, int blockLength)
            : base(stream)
        {
            if (stream == null)
            {
