//-------------------------------------------------------------------------------
// <copyright file="Ensure.cs" company="bbv Software Services AG">
...
namespace bbv.Common
{
    ...
    public static class Ensure
    {
        ...
        public static void ArgumentNotNegative(int argumentValue, string argumentName)
        {
            if (argumentValue < 0)
            {
                throw new ArgumentOutOfRangeException(argumentName, Ensure.NumberMustNotBeNegative);
            }
        }
        ...
        public static void ArgumentInRange<T>(bool condition, T argumentValue, string argumentName, string message)
        {
            ...
            if (!condition)
            {
                throw new ArgumentOutOfRangeException(argumentName, string.Format(CultureInfo.InvariantCulture, message, argumentValue, argumentName));
            }
        }
