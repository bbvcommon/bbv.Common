...
namespace bbv.Common.EventBroker.Extensions
{
    using System;
    ...
    /// </summary>
    public class LogExtension : EventBrokerExtensionBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogExtension"/> class.
        /// </summary>
        public LogExtension()
        {
        ...
        public LogExtension(string logger)
        {
