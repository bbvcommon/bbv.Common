//-------------------------------------------------------------------------------
// <copyright file="EventFiredHandlerBaseTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.DistributedEventBroker.Handlers
{
    using System;
    using EventBroker;
    using Events;
    ...
    public class EventFiredHandlerBaseTest : IDisposable
    {
        ...
        public void Handle_MustFireOnEventBroker()
        {
            ...
            this.internalEventBroker.Verify(broker => broker.Fire("topic://bbv.Common.DistributedEventBroker/DISTRIBUTED", this.testee, HandlerRestriction.Asynchronous, this.testee, It.IsAny<EventArgs<IEventFired>>()));
        }
