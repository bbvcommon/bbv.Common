//-------------------------------------------------------------------------------
// <copyright file="IResourceLoader.cs" company="bbv Software Services AG">
...
namespace bbv.Common.IO.Resources
{
    ...
    public interface IResourceLoader
    {
        ...
        Stream LoadResourceAsStream(Type type, string resourceName);
        ...
        /// <param name="resourceName">The full name including the namespace of the resource.</param>
        /// <returns>A <see cref="Stream"/> containing the contents of the embedded resource file</returns>
        Stream LoadResourceAsStream(Assembly assembly, string resourceName);
    }
}