//-------------------------------------------------------------------------------
// <copyright file="IIOAccessFactory.cs" company="bbv Software Services AG">
...
namespace bbv.Common.IO
{
    ...
    public interface IIOAccessFactory
    {
        ...
        void RegisterFileAccessExtensionsProvider(Func<IEnumerable<IFileAccessExtension>> extensionsProvider);
        ...
        void RegisterDirectoryAccessExtensionsProvider(Func<IEnumerable<IDirectoryAccessExtension>> extensionsProvider);
        ...
        void RegisterPathAccessExtensionsProvider(Func<IEnumerable<IPathAccessExtension>> extensionsProvider);
    }
}