//-------------------------------------------------------------------------------
// <copyright file="IDriveInfoAccess.cs" company="bbv Software Services AG">
...
namespace bbv.Common.IO
{
    ...
    public interface IDriveInfoAccess : ISerializable
    {
        ...
        /// </summary>
        /// <value>An <see cref="IDirectoryInfoAccess"/> object that contains the
        /// root directory of the drive.</value>
        IDirectoryInfoAccess RootDirectory { get; }
