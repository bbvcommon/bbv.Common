//-------------------------------------------------------------------------------
// <copyright file="StateDictionary.cs" company="bbv Software Services AG">
...
namespace bbv.Common.StateMachine.Internals
{
    ...
    public class StateDictionary<TState, TEvent> : IStateDictionary<TState, TEvent> where TState : struct, IComparable
