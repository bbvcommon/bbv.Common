//-------------------------------------------------------------------------------
// <copyright file="UserInterfaceThreadSynchronizerTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.Threading
{
    ...
    public class UserInterfaceThreadSynchronizerTest
    {
        ...
        private readonly Mock<IUserInterfaceThreadSynchronizerLogExtension> logExtensionMock;
        ...
        public void LoggingWhenSynchronousOperationThenCallsLogExtensionSynchronousLogging()
        {
            ...
            this.logExtensionMock
                .Verify(logExtension => logExtension.LogSynchronous(action, Thread.CurrentThread.ManagedThreadId, Thread.CurrentThread.Name));
        }
        ...
        public void LoggingWhenAsynchronousOperationThenCallsLogExtensionAsynchronousLogging()
        {
            ...
            this.logExtensionMock
                .Verify(logExtension => logExtension.LogAsynchronous(action, Thread.CurrentThread.ManagedThreadId, Thread.CurrentThread.Name));
        }
