...
namespace bbv.Common.Bootstrapper.Syntax
{
        ...
        where TExtension : IExtension
    {
        ...
        IExecutable CreateExecutable(Action action);
        ...
        /// <returns>An executable.</returns>
        IExecutable CreateExecutable<TContext>(Func<TContext> initializer, Action<TExtension, TContext> action);
        ...
        /// <param name="action">The action.</param>
        /// <returns>An executable.</returns>
        IExecutable CreateExecutable(Action<TExtension> action);
    }
}