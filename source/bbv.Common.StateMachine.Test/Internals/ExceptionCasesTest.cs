//-------------------------------------------------------------------------------
// <copyright file="ExceptionCasesTest.cs" company="bbv Software Services AG">
...
namespace bbv.Common.StateMachine.Internals
{
    ...
    public class ExceptionCasesTest
    {
        ...
        /// <summary>
        /// the event arguments that was provided in the <see cref="StateMachine{TState,TEvent}.ExceptionThrown"/> event.
        /// </summary>
            ...
            this.testee.TransitionExceptionThrown += (sender, eventArgs) =>
                                                         {
                                                             ...
                                                             this.recordedEventArguments = eventArgs.EventArguments;
                                                             this.recordedException = eventArgs.Exception;
                                                         };
        }
        ...
        public void ExceptionThrowingGuard()
        {
            ...
            this.testee.In(States.A)
                .On(Events.B)
                    .If(arguments => { throw exception; }).Goto(States.B);
        ...
        private void AssertException(States expectedStateId, Events expectedEventId, object[] expectedEventArguments, Exception expectedException)
        {
            ...
            Assert.Equal(expectedEventArguments, this.recordedEventArguments);
