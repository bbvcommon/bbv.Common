//-------------------------------------------------------------------------------
// <copyright file="StateMachineTestBase.cs" company="bbv Software Services AG">
...
namespace bbv.Common.StateMachine
{
        ...
        where TStateMachine : IStateMachine<States, Events>
    {
        ...
        public void StartStop()
        {
            ...
            bool isRunningInitially = this.testee.IsRunning;
            this.testee.Start();
            bool isRunningAfterStart = this.testee.IsRunning;
            this.testee.Stop();
            bool isRunningAfterStop = this.testee.IsRunning;

            Assert.False(isRunningInitially, "initially");
            Assert.True(isRunningAfterStart, "after start");
            Assert.False(isRunningAfterStop, "after stop");
        }
        ...
        public void FireEvent()
        {
            ...
            object[] eventArguments = new object[] { 1, 2, "test" };
        ...
        public void PriorityFire()
        {
            ...
            this.testee.In(States.A)
                .On(Events.B).Goto(States.B).Execute(eventArguments =>
                {
        ...
        protected void CheckTransitionCompletedMessage(object[] eventArguments, States origin, Events eventId, States newState)
        {
            ...
            {
                Assert.Equal(eventArguments, this.TransitionCompletedMessages[0].EventArguments);
            }
        ...
        /// <param name="eventId">The event id.</param>
        /// <param name="eventArguments">The event arguments.</param>
        protected void CheckBeginTransitionMessage(States origin, Events eventId, object[] eventArguments)
        {
            ...
            Assert.Equal(eventArguments, this.TransitionBeginMessages[0].EventArguments);
        }
