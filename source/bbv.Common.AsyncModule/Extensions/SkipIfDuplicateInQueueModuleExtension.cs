//-------------------------------------------------------------------------------
// <copyright file="SkipIfDuplicateInQueueModuleExtension.cs" company="bbv Software Services AG">
...
namespace bbv.Common.AsyncModule.Extensions
{
    ...
    public class SkipIfDuplicateInQueueModuleExtension : IModuleExtension
    {
        ...
        /// <param name="e">The <see cref="bbv.Common.AsyncModule.Events.BeforeConsumeMessageEventArgs"/> instance containing the event data.</param>
