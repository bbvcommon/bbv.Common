...
namespace bbv.Common.Bootstrapper.Specification.Dummies
{
    ...
    public class CustomExtensionWithConfigurationWhichKnowsWhereToLoadFrom : ICustomExtensionWithConfiguration, ILoadConfigurationSection, IConsumeConfigurationSection
    {
